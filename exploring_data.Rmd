# Data Exploration
Because missing or invalid data have been multiply imputed, the DXX_D data release file contains 5 records for each survey participant who was interviewed and examined. Only 1 record was used in calculating sample sizes. However, all 5 records was used in analyses in order to obtain more accurate variance estimates. The records for some survey participants, such as pregnant females, were blank as  pregnant females were not eligible for the DXA scan.
